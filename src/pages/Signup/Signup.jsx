          ...
          <>
            ...
            {error && (
              <div className="mb-4 p-3 bg-red-50 border border-red-200 text-red-700 text-sm rounded-md">
                {error}
                {isOAuthAccountExists && (
                  <div className="mt-3">
                    <a
                      href={`${import.meta.env.VITE_API_URL || "http://localhost:3000/api"}/auth/github`}
                      className="inline-flex items-center justify-center space-x-2 px-4 py-2 bg-black text-white text-sm rounded-md hover:bg-gray-800 transition-colors"
                    >
                      <svg
                        className="w-4 h-4"
                        fill="currentColor"
